...
func Register(mux *http.ServeMux, staticHandler http.Handler) {
	...
	mux.HandleFunc("/api/trial-balance/save", authhandlers.WithAuth(financehandlers.SaveTrialBalance))
	mux.HandleFunc("/api/trial-balance/add", authhandlers.WithAuth(financehandlers.AddTrialBalanceLine))
	mux.HandleFunc("/api/trial-balance/delete", authhandlers.WithAuth(financehandlers.DeleteTrialBalanceLine))
